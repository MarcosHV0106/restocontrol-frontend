          ...
          <div>
            <div class="page-header mb-4">
              ...
              <p class="page-subtitle">
                Registra productos y administra la orden de la mesa.
              </p>
        ...
        <div class="row g-4 mt-2">
          <div class="col-lg-8">
            ...
            <div class="row g-3">
              ...
              <div v-else class="col-6 col-md-4 col-xl-3" v-for="alimento in alimentosFiltrados"
              ...
              <div class="card-body px-4 d-flex flex-column" style="height: 550px;">
                <div class="flex-grow-1 overflow-auto pe-2 mb-3 custom-scroll">
                  <div v-if="carrito.length === 0" class="empty-cart-state text-center py-5">
                    <img src="https://cdn-icons-png.flaticon.com/512/10522/10522130.png" width="80"
                      class="opacity-25 mb-3">
                    <p class="text-muted">Aún no hay platos en esta cuenta</p>
                  </div>

                  <div v-else v-for="item in carrito" :key="item.idAlimento"
                    class="cart-item mb-3 p-3 rounded-3">
                ...
                <div class="order-summary border-top pt-3">
                  <textarea v-model="observacion" class="form-control form-control-sm border-0 bg-light mb-3" rows="2"
                    placeholder="Observaciones (Ej. Término medio, sin sal...)"></textarea>
                  ...
                  <div class="row g-2">
                    <div class="col-12">
                      <button class="btn btn-brand w-100 py-3 text-white fw-bold shadow-sm rounded-3"
                        @click="procesarPedido" :disabled="carrito.length === 0 || cargando">
                        <span v-if="cargando" class="spinner-border spinner-border-sm me-2"></span>
                        {{ esEdicion ? 'Actualizar Orden' : 'Reservar' }}
                      </button>
                    </div>
                    <div class="col-12">
                      <button class="btn btn-white w-100 py-3 border fw-bold rounded-3 text-dark shadow-sm"
                        @click="regresar">
                        Cancelar
                      </button>
                    </div>
